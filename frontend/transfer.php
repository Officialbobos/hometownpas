...
<body>
                ...
                <form action="<?php echo rtrim(BASE_URL, '/'); ?>/frontend/make_transfer.php" method="POST" id="transferForm">
                    ...
                    <div id="fields_external_canada_eft" class="external-fields">
                        <div class="form-group">
                            ...
                            <select id="recipient_saved_account_id_canada" name="recipient_saved_account_id_canada" class="form-control">
                    ...
                    <button type="button" class="button-primary" id="initiateTransferBtn">Initiate Transfer</button>
                </form>
            </div>
    ...
    <div class="pin-modal-overlay" id="transferPinModal">
        <div class="pin-modal-content">
            <h3>Confirm Transfer PIN</h3>
            <p>Please enter your **4-digit Transfer PIN** to authorize this transaction.</p>
            <form id="pinConfirmationForm" method="POST" action="<?php echo rtrim(BASE_URL, '/'); ?>/frontend/make_transfer.php">
                ...
                <input type="password" id="transfer_pin" name="transfer_pin" class="form-control" maxlength="4" placeholder="••••" required>
                <button type="submit" class="modal-button">Confirm PIN & Transfer</button>
                <button type="button" class="modal-button" id="cancelPinBtn" style="background-color: #dc3545; margin-top: 10px;">Cancel</button>
            </form>
