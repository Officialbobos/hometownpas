...
# --- IMPORTANT: ADDED LINES BELOW ---
# Set the correct permissions for the log directory
# The web server user on Render is 'www-data'
# This command makes the 'users' directory writable by the web server
RUN chmod -R 775 /var/www/html/heritagebank_admin/users/
# --- IMPORTANT: ADDED LINES ABOVE ---
