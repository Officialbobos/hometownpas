 ...
 * This assumes the `sendEmail` function is defined in `functions.php`.
 */
function send_transaction_update_email_notification($user_email, $tx_details, $new_status, $admin_comment) {
    ...
    // Email body generation and styling logic here...
    $body = "
        <p>Dear Customer,</p>
        <p>This is to inform you about an update regarding your recent transaction with HomeTown Bank Pa.</p>
    ...
    switch (strtolower($new_status)) {
        case 'approved': case 'completed': $body .= "green;"; break;
        case 'declined': case 'restricted': case 'failed': $body .= "red;"; break;
        case 'on hold': $body .= "orange;"; break;
        case 'refunded': $body .= "teal;"; break;
        default: $body .= "black;";
    }
        ...
        try {
            ...
            if (!$original_tx_details) {
                ...
                if ($update_result->getModifiedCount() > 0 || $update_result->getMatchedCount() > 0) {
                    ...
                    if ($user_email && $updated_tx_details) {
                        if (send_transaction_update_email_notification($user_email, (array)$updated_tx_details, $new_status, $admin_comment_message)) {
